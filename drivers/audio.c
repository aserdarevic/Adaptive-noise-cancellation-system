...
{    
    ...
    if (mode == IO_METHOD_DMA)
    {
        i2s_init(sampling_rate, IO_METHOD_DMA);   //Configure I2S to work with DMA
    ...
    { //Mode interruptions
        i2s_init(sampling_rate , IO_METHOD_INTR);   //Configure I2S to work with interrupts
